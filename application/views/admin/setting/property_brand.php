        ...
        <div class="col-lg-12">
            ...
            <?php } ?>
                ...
                <div class="add-edit-form">
                    <form action="<?php echo base_url('setting/property_brand'); ?>" method="post" class="form-borderless">
                        <?php echo (!empty($record))? "<input type='hidden' name='id' value='".$record->id."'>":""; ?>
                        <div class="col-sm-4 form-group">
                            <label class="col-md-4 control-label" for="text-input">Name</label>
                            <div class="col-md-8">
                            <input type="text" id="brandname" name="brandname" class="form-control" value="<?php echo (empty($record) ? '' : $record->brandname);?>" required>
                            </div>
                        </div>
                ...
                <table class="table table-striped table-borderless table-vcenter">
                    ...
                    <?php foreach($records as $k=>$r) { ?>
                        <tr id="tabl">
                            <td><?php echo $k+1 ?></td>
                            <td class="grpname"><?php echo $r->brandname ?></td>
                            <td><?php echo $r->description ?></td>
                            <td><?php echo $r->userlevel ?></td>
                            <td class="text-center">
                                <a href="<?php echo base_url("setting/propertybrand/".$r->id) ?>" data-toggle="tooltip" title="Edit <?php echo $title; ?>" class="btn btn-effect-ripple btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                <a href="<?php echo base_url("delete/index/brands/".$r->id) ?>" data-toggle="tooltip" title="Delete <?php echo $title; ?>" class="btn btn-effect-ripple btn-xs btn-danger"  onclick="return confirm('Are you Sure?');"><i class="fa fa-times"></i></a>
                            </td>
                        <tr>
                    <?php } ?>
                    </tbody>
