...
<!--[if gt IE 9]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <?php if ($template['theme']) { ?><link rel="stylesheet" href="css/admin/themes/<?php echo $template['theme']; ?>.css" id="theme-link"><?php } ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url('assets/admin/css/alertify.default.css');?>">
