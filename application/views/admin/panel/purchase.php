        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="header-section">
                    <h1>Stock <?php echo isset($record['0']->id) ? 'Update': 'Entry'; ?></h1>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="block">
                ...
                <form action="<?php echo base_url('panel/purchase') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" name="purchaseorder" class="form-control" placeholder="Enter Purchase Order" <?php echo !empty($stock['purchaseorder'])? 'value="'.$stock['purchaseorder'].'" readonly':''; ?>>
                        </div>
                        <label class="col-md-2 control-label">Purchase Date</label>
                        <div class="col-md-3">
                            <input type="text" name="purchasedate"  class="input-datepicker form-control" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" <?php echo !empty($stock['purchasedate'])? 'value="'.$stock['purchasedate'].'" readonly':''; ?>>
                        </div>
                    </div> 
                    <div class="form-group">
                        <label class="col-md-2 control-label">Authorized By</label>
                        <div class="col-md-3">
                            <input type="text" name="authorizedby" class="form-control" <?php echo !empty($stock['authorizedby'])? 'value="'.$stock['authorizedby'].'" readonly':''; ?>>
                        </div>
                        <label class="col-md-2 control-label">Prepared By</label>
                        <div class="col-md-3">
                            <input type="text" name="preparedby" class="form-control" <?php echo !empty($stock['preparedby'])? 'value="'.$stock['preparedby'].'" readonly':''; ?>>
                        </div>
                    </div> 
                    <hr>
