    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
        ...
        <div class="panel panel-default" >
            <div class="panel-heading">
                <div class="panel-title text-center"><strong>Nyokas</strong> Login Panel</div>
            </div>     

            <div class="panel-body" >

                <form action="<?php echo base_url('user'); ?>" name="form" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST">
