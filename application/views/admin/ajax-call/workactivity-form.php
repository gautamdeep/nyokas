...
<input type="hidden" name="complainid" value="<?php echo $complainid; ?>" />
<fieldset>
...
<div class="form-group form-actions">
    <div class="col-md-9">
        <button type="submit" id="update-activity" class="btn btn-effect-ripple btn-success" name="submit" value="update">Update Activity</button>
    </div>
</div>
</fieldset>
</form>
